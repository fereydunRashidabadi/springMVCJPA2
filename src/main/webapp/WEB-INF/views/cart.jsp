      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-12">
          <h1 class="title">سبد خرید</h1>
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td class="text-center"><a href="product"><img src="static/image/product/samsung_tab_1-50x50.jpg" alt="تبلت ایسر" title="تبلت ایسر" class="img-thumbnail" /></a></td>
                    <td class="text-left"><a href="product">تبلت ایسر</a><br />
                  ...
                  <tr>
                    <td class="text-center"><a href="product"><img src="static/image/product/sony_vaio_1-50x50.jpg" alt="کفش راحتی مردانه" title="کفش راحتی مردانه" class="img-thumbnail" /></a></td>
                    <td class="text-left"><a href="product">کفش راحتی مردانه</a></td>
          ...
          <div class="buttons">
            ...
            <div class="pull-right"><a href="checkout" class="btn btn-primary">تسویه حساب</a></div>
          </div>
        </div>
        <!--Middle Part End -->
      </div>
