    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-12">
          <h1 class="title">عناصر</h1>
          <div class="divider"></div>
          <div class="row">
            <div class="col-sm-6">
              <h2 class="text-uppercase">تایپوگرافی</h2>
              <h1>سرتیتر H1. عنوان آزمایشی در اینجا</h1>
              <h2>سرتیتر H2. عنوان آزمایشی در اینجا</h2>
              <h3>سرتیتر H3. عنوان آزمایشی در اینجا</h3>
              <h4>سرتیتر H4. عنوان آزمایشی در اینجا</h4>
              <h5>سرتیتر H5. عنوان آزمایشی در اینجا</h5>
              <h6>سرتیتر H6. عنوان آزمایشی در اینجا</h6>
              <div class="divider"></div>
              <h2 class="text-uppercase">Accordion</h2>
              <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="accordion-toggle" href="#accordion-1">عنوان آکوردیون #1 <i class="fa fa-caret-down"></i></a></h4>
                  </div>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="accordion-toggle" href="#accordion-2">عنوان آکوردیون #2 <i class="fa fa-caret-down"></i></a></h4>
                  </div>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="accordion-toggle" href="#accordion-3">عنوان آکوردیون #3 <i class="fa fa-caret-down"></i></a></h4>
                  </div>
              ...
              <h2 class="text-uppercase">لیست</h2>
              <div class="row">
                <div class="col-md-6 col-lg-6">
                  <h5 class="text-uppercase">نامرتب</h5>
                  <ul class="simple-ul">
                    <li>لورم ایپسوم دولور آمت</li>
                    <li>کانسکیوتور ادیپیسینگ الیت </li>
                    <li>دونک اروس تلوس </li>
                    <li>نالم آک نیسی نان اروس گراویدا ونانتیس
                      <ul>
                        <li>لیبرو ماسا داپیبوس دی یور</li>
                        <li>سلریسک نک ریونکاس اگت</li>
                        <li>پراسنت ویتای دوای</li>
                        <li>اوت یوسمود تورپیس سولایسیتودین</li>
                      </ul>
                    </li>
                    <li>دولور سیت کانسکیوتر آمت</li>
                    <li>وهیکولا ونناتیس، تمپور ویتالی</li>
                    <li>فریمیوم درک باوروس باکتریا</li>
                    <li>موریس آموس جزایر لورم باس</li>
                  </ul>
                  <div class="divider visible-sm visible-xs"></div>
                </div>
                <div class="col-md-6 col-lg-6">
                  <h5 class="text-uppercase">مرتب</h5>
                  <ul class="decimal-list">
                    <li>لورم ایپسوم دولور آمت</li>
                    <li>کانسکیوتور ادیپیسینگ الیت</li>
                    <li>دونک اروس تلوس </li>
                    <li>نالوم آراستوس نان بیماتوس گراویت</li>
                    <li>لیبرو ماسا داپیبوس دی یور</li>
                    <li>سلریسک نک ریونکاس اگت</li>
                    <li>پراسنت ویتای دوای</li>
                    <li>اوت یوسمود تورپیس سولایسیتودین</li>
                    <li>ای سی کولینک لیبرتوس وال آوتپوت</li>
                    <li>فسیلیتی پورتا لانگ کنسر ول کن</li>
                    <li>اج آو نو پورتوریکو لورم</li>
                    <li>اینتیجر یا فایل تایپ ول نیب ست آمت</li>
                  </ul>
                </div>
              </div>
              <div class="divider"></div>
              <h2 class="text-uppercase">دکمه ها</h2>
              <div class="row">
                <div class="col-sm-4">
                  <button class="btn btn-primary btn-lg" onClick="">دکمه بزرگ</button>
                  <br>
                  <br>
                  <button class="btn btn-primary" onClick="">دکمه پیشفرض</button>
                  <br>
                  <br>
                  <button class="btn btn-primary btn-sm" onClick="">دکمه کوچک</button>
                </div>
                <div class="col-sm-4">
                  <button class="btn btn-default btn-lg" onClick="">دکمه بزرگ</button>
                  <br>
                  <br>
                  <button class="btn btn-default" onClick="">دکمه پیشفرض</button>
                  <br>
                  <br>
                  <button class="btn btn-default btn-sm" onClick="">دکمه کوچک</button>
                </div>
                <div class="col-sm-4">
                  <button class="btn btn-warning" onClick="">دکمه هشدار</button>
                  <br>
                  <br>
                  <button class="btn btn-danger" onClick="">دکمه خطر</button>
                  <br>
                  <br>
                  <button class="btn btn-success" onClick="">دکمه موفقیت</button>
                  <br>
                  <br>
                  <button class="btn btn-info" onClick="">دکمه اطلاعات</button>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <h2 class="text-uppercase">باکس هشدار</h2>
              <div class="alert alert-info"><i class="fa fa-info-circle"></i> اطلاعات - متن دلخواه خود را در اینجا قرار دهید.</div>
              <div class="alert alert-success"><i class="fa fa-check-circle"></i> موفقیت - متن دلخواه خود را در اینجا قرار دهید.</div>
              <div class="alert alert-warning"><i class="fa fa-warning"></i> هشدار - متن دلخواه خود را در اینجا قرار دهید.</div>
              <div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> خطر - متن دلخواه خود را در اینجا قرار دهید.</div>
              <h2 class="text-uppercase">تب ها</h2>
              <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#tab-1">تب #1</a></li>
                <li><a data-toggle="tab" href="#tab-2">تب #2</a></li>
                <li><a data-toggle="tab" href="#tab-3">تب #3</a></li>
              </ul>
              <div class="tab-content">
                <div class="tab-pane active" id="tab-1">لورم ایپسوم دولور ست آمت، نوشته تست فارسی تصمیم پر کردن اینجا. معمولا طراحان گرافیک برای صفحه‌آرایی، نخست از متن‌های آزمایشی و بی‌معنی استفاده می‌کنند. پراسنت ویتای دوای. شاید در قرون جدید.</div>
                <div class="tab-pane" id="tab-2">معمولا طراحان گرافیک برای صفحه‌آرایی، نخست از متن‌های آزمایشی و بی‌معنی استفاده می‌کنند. پراسنت ویتای دوای. شاید در قرون جدید. لورم ایپسوم دولور ست آمت، نوشته تست فارسی تصمیم پر کردن اینجا.</div>
                <div class="tab-pane" id="tab-3">نسخه جدید الیت برای حرفه ای ها. معمولا طراحان گرافیک برای صفحه‌آرایی، نخست از متن‌های آزمایشی و بی‌معنی استفاده می‌کنند. پراسنت ویتای دوای. شاید در قرون جدید. لورم ایپسوم دولور سیت.</div>
              </div>
              <div class="divider"></div>
              <h2 class="text-uppercase">نقل قول</h2>
              <blockquote>
                <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. </p>
                <footer>ایپسوم دولور سیت</footer>
              </blockquote>
              <h2 class="text-uppercase">نقل قول برعکس</h2>
              <blockquote class="blockquote-reverse">
                <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. </p>
                <footer>ایپسوم دولور سیت</footer>
              </blockquote>
              <h2 class="text-uppercase">دراپ کپس</h2>
              <p> <span class="dropcap custom-color">م</span> تن آموزشی و تستی به زبان فارسی برای پر کردن اینجا. خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.</p>
            </div>
          </div>
          <div class="divider"></div>
          <h2 class="text-uppercase">جداول</h2>
          <div class="row">
            <div class="col-md-6">
              <h4 class="text-uppercase">جداول ساده</h4>
              <table class="table">
                <thead>
                  <tr>
                    <th>#</th>
              ...
              <h4 class="text-uppercase">جداول راه راه</h4>
            ...
            <div class="col-md-6">
              <h4 class="text-uppercase">جداول کادر دار</h4>
              <div class="table-responsive">
                <table class="table table-bordered">
                  <thead>
                    <tr>
              ...
              <h4 class="text-uppercase">جداول با ستون حالت شناوری</h4>
              <div class="table-responsive">
          ...
          <div class="divider"></div>
          <h2 class="text-uppercase">شبکه</h2>
          <div class="row">
            <div class="col-lg-12">
              <h5>1 ستون</h5>
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <h5>1/3 ستون</h5>
              <p>زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد. </p>
            </div>
          </div>
          <div class="divider"></div>
          <div class="row">
            <div class="col-sm-6 col-md-3 col-lg-3">
              <h5>1/4 ستون</h5>
              <p>لورم ایپسوم دولور ست آمت، نوشته تست فارسی تصمیم پر کردن اینجا. دونک اروس تلوس, زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد. </p>
            </div>
            <div class="col-sm-6 col-md-3 col-lg-3">
              <h5>1/4 ستون</h5>
              <p>لورم ایپسوم دولور ست آمت، نوشته تست فارسی تصمیم پر کردن اینجا. دونک اروس تلوس, زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد. </p>
          ...
          <div class="row">
            <div class="col-sm-6 col-md-2 col-lg-2">
              <h5>1/6 ستون</h5>
              <p>لورم ایپسوم دولور ست آمت، نوشته تست فارسی تصمیم پر کردن اینجا. دونک اروس تلوس, تست نوشتاری به زبان فارسی.</p>
            </div>
            <div class="col-sm-6 col-md-2 col-lg-2">
              <h5>1/6 ستون</h5>
              <p>لورم ایپسوم دولور ست آمت، نوشته تست فارسی تصمیم پر کردن اینجا. دونک اروس تلوس, تست نوشتاری به زبان فارسی.</p>
