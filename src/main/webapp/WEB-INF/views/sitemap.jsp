        ...
        <div id="content" class="col-sm-12">
          ...
          <div class="row">
            ...
            <div class="col-md-5 col-sm-6">
              <ul class="sitemap">
                <li><a href="category">البسه</a>
                  <ul>
                    <li><a href="category">آقایان</a>
                      <ul>
                        <li><a href="category">زیردسته ها</a></li>
                        <li><a href="category">زیردسته ها</a></li>
                        <li><a href="category">زیردسته ها</a></li>
                ...
                <li><a href="category">الکترونیکی</a>
                  <ul>
                    <li><a href="category">لپ تاپ</a>
                      <ul>
                        <li><a href="category">زیردسته های جدید</a></li>
                        <li><a href="category">زیردسته های جدید</a></li>
                        <li><a href="category">زیردسته جدید</a></li>
                    ...
                    <li><a href="category">دوربین</a>
                      <ul>
                        <li><a href="category">زیردسته های جدید</a></li>
                      </ul>
                    </li>
                    <li><a href="category">موبایل و تبلت</a>
                      <ul>
                        <li><a href="category">زیردسته های جدید</a></li>
                        <li><a href="category">زیردسته های جدید</a></li>
                      </ul>
                    </li>
                    <li><a href="category">صوتی و تصویری</a>
                      <ul>
                        <li><a href="category">زیردسته های جدید</a></li>
                        <li><a href="category">زیردسته جدید</a></li>
                      </ul>
                ...
                <li><a href="category">کفش</a>
                  <ul>
                    <li><a href="category">آقایان</a> </li>
                    <li><a href="category">بانوان</a>
                      <ul>
                        <li><a href="category">زیردسته های جدید</a></li>
                        <li><a href="category">زیردسته ها</a></li>
                      </ul>
                ...
                <li><a href="category">جواهرات</a>
                  <ul>
                    <li><a href="category">نقره</a>
                      <ul>
                        <li><a href="category">زیردسته های جدید</a></li>
                        <li><a href="category">زیردسته های جدید</a></li>
                      </ul>
                    </li>
                    <li><a href="category">طلا</a>
                      <ul>
                        <li><a href="category">تست 1</a></li>
                        <li><a href="category">تست 2</a></li>
                      </ul>
                    ...
                    <li><a href="category">الماس</a> </li>
                    <li><a href="category">مروارید</a>
                      <ul>
                        <li><a href="category">زیردسته های جدید</a></li>
                      </ul>
                    </li>
                    <li><a href="category">زیورآلات آقایان</a> </li>
                    <li><a href="category">زیورآلات کودکان</a>
                      <ul>
                        <li><a href="category">زیردسته های جدید</a></li>
                      </ul>
                    </li>
                ...
                <li><a href="category">زیبایی و سلامت</a>
                  <ul>
                    <li><a href="category">عطر و ادکلن</a> </li>
                    <li><a href="category">آرایشی</a> </li>
                    <li><a href="category">ضد آفتاب</a> </li>
                ...
                <li><a href="category">کودک و نوزاد</a>
                  <ul>
                    <li><a href="category">اسباب بازی</a> </li>
                    <li><a href="category">بازی</a>
                      <ul>
                        <li><a href="category">تست 25</a></li>
                      </ul>
                    </li>
                ...
                <li><a href="category">خانه و باغچه</a>
                  <ul>
                    <li><a href="category">لوازم خواب</a> </li>
                    <li><a href="category">خوراک</a> </li>
                    <li><a href="category">لوازم منزل</a> </li>
            ...
            <div class="col-md-4 col-sm-6">
              <ul class="sitemap">
                ...
                <li><a href="login">حساب کاربری من</a>
                  <ul>
