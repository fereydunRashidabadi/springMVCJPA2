  ...
  <div id="container">
    <div class="container">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="compare">مقایسه محصولات</a></li>
      </ul>
      <!-- Breadcrumb End-->
      <div class="row">
        <!--Middle Part Start-->
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <tr>
                  <td>محصولات</td>
                  <td><a href="product"><strong>لپ تاپ ایلین ور</strong></a></td>
                  <td><a href="product"><strong>کتاب آموزش باغبانی</strong></a></td>
                  <td><a href="product"><strong>تبلت ایسر</strong></a></td>
                </tr>
                <tr>
                  <td>تصویر</td>
                  <td class="text-center"><img class="img-thumbnail" title="لپ تاپ ایلین ور" alt="لپ تاپ ایلین ور" src="static/image/product/macbook_air_1-90x90.jpg"></td>
                  <td class="text-center"><img class="img-thumbnail" title=" کتاب آموزش باغبانی " alt=" کتاب آموزش باغبانی " src="static/image/product/macbook_pro_1-90x90.jpg"></td>
                  <td class="text-center"><img class="img-thumbnail" title="تبلت ایسر" alt="تبلت ایسر" src="static/image/product/samsung_tab_1-90x90.jpg"></td>
                </tr>
                <tr>
                  <td>قیمت</td>
