    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-9" id="content">
          ...
          <form class="form-horizontal" method="POST" modelAttribute="user">
            <fieldset id="account">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input path="firstName" id="firstName" type="text" class="form-control"  placeholder="نام" value="" name="firstName">
                </div>
              </div>
              <div class="form-group required">
                <label for="lastName" class="col-sm-2 control-label">نام خانوادگی</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="lastName" path="lastName" placeholder="نام خانوادگی" value="" name="lastName">
                </div>
              </div>
              <div class="form-group required">
                <label for="ssoId" class="col-sm-2 control-label">نام کاربری</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="ssoId" path="ssoId" placeholder="با حروف لاتین" value="" name="ssoId">
                </div>
              </div>
              <div class="form-group required">
                <label for="email" class="col-sm-2 control-label">آدرس ایمیل</label>
                <div class="col-sm-10">
                  <input path="email" id="email" type="email" class="form-control" placeholder="آدرس ایمیل" value="" name="email">
                </div>
              </div>
              <div class="form-group required">
            ...
            <fieldset>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input path="password" id="password" type="password" class="form-control" placeholder="رمز عبور" value="" name="password">
                </div>
              </div>
              <div class="form-group required">
